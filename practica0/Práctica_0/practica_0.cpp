...
void Monigote ()
{
    ...
    float ala_sombrero[4][3]={{-0.35,0.5,0.0},{0.35,0.5,0.0},
...
//contorno car
   ...
   glEnd();
    ...
    glColor3f(1,0,0);
    Circle(0.1,0,0.7,20,GL_FILL);

    glColor3f(1,1,0);
    Circle(0.07,0,0.7,20,GL_FILL);

    glColor3f(1,0,0);
    Circle(0.03,0,0.7,20,GL_FILL);
...
//ojo der
    ...
    //punto blanco
    glColor3f(1,1,1);
    Circle(0.015,0.1,0.4,20,GL_FILL);
